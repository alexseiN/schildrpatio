...
use App\Models\backend\Reviewsmodel;

class Reviews extends Admincontroller {
    public $_table_names = 'reviews';			//set table name
    public $_subView = 'admin/reviews/';		//set subview
    public $_redirect = '/reviews';				//set controller link
    ...
    public function __construct(){
        ...
        $this->data['ThisModule'] = $this->ReviewsModel;
        $this->data['CommanModel'] = $this->CommanModel;
        
        $this->data['uploadFolder'] = 'assets/uploads/reviews';
        ...
        $main_array_view = array(
                    "view_data"=>array(
                        ...
                        "add_link"=>array("status"=>"yes","link"=>$this->data['admin_link'].'/reviews/edit'),
                        "order_link"=>"yes"
                    )
                );
        ...
        if(!empty($this->postdata)) {
            ...
            if($input) {
                ...
                if(is_null($id)) {
                    ...
                    $d_action = 'New Review added.';
                }
                else {
                    $d_action = 'Review updated.';
