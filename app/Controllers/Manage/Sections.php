...
use App\Models\backend\Sectionsmodel;

class Sections extends Admincontroller {
    public $_table_names 	= 'sections';		//set table
    public $_subView = 'admin/sections/';			//set subview
    public $_mainView = 'admin/_layout_main';		//set mainview
    public $_redirect = '/sections';				//set controller link
    ...
    public function __construct(){
        ...
        $this->data['ThisModule'] = $this->SectionsModel;
        
        $this->data['uploadFolder'] = 'assets/uploads/sections';
    ...
    public function edit($c_id=false,$id = NULL){ 
        ...
        $blank_array = array();
        if($id){
            $this->data['name'] = 'Edit Page Section';
            $this->data['title'] = $this->data['name'];
            $where['id'] = $id;
            ...
            error_reporting(1);
            $this->data['name'] = 'Create Page Section';
            $this->data['title'] = $this->data['name'];
        ...
        if(!empty($this->postdata)) {
            ...
            if($input) {
                ...
                if($id == NULL){
                    ...
                    $d_action = 'New Page Section added.';
                }
                else {
                    $d_action = 'Page Section updated.';
