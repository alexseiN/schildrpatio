...
class Faq extends Admincontroller {
    public $_table_names = 'faqs';		//set table name
    public $_subView = 'admin/faqs/';	//set subview
    public $_redirect = '/faq';          //set controller link
    ...
    public function __construct(){
        ...
        $this->data['ThisModule'] = $this->FaqModel;
        ...
        $main_array_view = array(
                    "view_data"=>array(
                        ...
                        "add_link"=>array("status"=>"yes","link"=>$this->data['admin_link'].'/faq/edit'),
                        "order_link"=>"yes"
                    )
                );
        ...
        if(!empty($this->postdata)) {
            ...
            if($input) {
                if(is_null($id)) {
                    ...
                    $data['created'] = time();
                    $data['modified'] = time();	    
                    $d_action = 'New FAQ added.';
                }
                else {
                    $d_action = 'FAQ updated.';
                    $data['modified'] = time();
                }
