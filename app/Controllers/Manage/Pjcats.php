...
use App\Models\backend\Pjcatsmodel;

class Pjcats extends Admincontroller
{
    public $_table_names 	= 'pjcats';		//set table
    public $_subView = 'admin/pjcats/';			//set subview
    public $_mainView = 'admin/_layout_main';		//set mainview
    public $_redirect = '/pjcats';				//set controller link
    ...
    public function __construct(){
        ...
        $this->PjcatsModel = new Pjcatsmodel();
        $this->data['ThisModule'] = $this->PjcatsModel;
        
        $this->data['uploadFolder'] = 'assets/uploads/pjcats';
        ...
        $main_array_view = array(
                    "view_data"=>array(
                        ...
                        "add_link"=>array("status"=>"yes","link"=>$this->data['admin_link'].'/pjcats/edit'),
                        "order_link"=>"yes"
                    )
                );
        ...
        if(!empty($this->postdata)) {
            ...
            if($input) {
                ...
                if(is_null($id)) {
                    ...
                    $d_action = 'New Project Category added.';
                }
                else {
                    $d_action = 'Project Category updated.';
                }		
