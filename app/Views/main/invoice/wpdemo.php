                ...
                <div class="invoice-header row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <span>
                            ...
                            <img width="130" src="assets/uploads/branches/full/<?= $thisbranch->image ?>" />
                        ...
                        <img width="130" style="filter: brightness(10%);" src="assets/uploads/sites/<?= $main->logo ?>" />
                ...
                <div class="invoice-footer pagebreak">
                    ...
                    <div class="col-sm-9 standartnotes ns">
                        ...
                        <ul style="margin-top:20px;display:none;">
                            ...
                            <img style="width:120px;filter: brightness(10%);" src="assets/uploads/sites/<?= $main->logo ?>" />
