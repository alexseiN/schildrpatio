...
<div class="main_top">
	...
	<div class="carousel" style="height: 87.5vh">
		<div class="bg_top" style="background-image:  url(assets/uploads/blogs/full/<?= $blog->image ?>); ">
			<div class="bg_layer">
			</div>
		</div>
	...
	<div class="bread" style="margin-top: 15px">
		<div class="bread_crumb">
			<ul class="breadcrumb">
				...
				<li><i><a href="<?=$curlangcode?>/page/blog">Blog</a></i></li>
		...
		<div class="page_title pb-0 pl_992_0" style="padding: 0;">
			<div class="main_center">
				<div class="col-md-12 text-uppercase" style="border-top: 1px solid #7396ae;  padding-left: 0;">
					<h1 class="text-uppercase" style="font-size: 45.7px; font-family: 'Barlow', sans-serif; font-weight: normal; color: #232323; margin-top: 30px;"><?= $blog->title ?></h1>
				</div>
...
<?php echo view('main/includes/bsections'); ?>
