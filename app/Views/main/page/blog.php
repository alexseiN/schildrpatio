...
<div class="container-fluid main_center">
        ...
        <div class="project" style="width: 100%">
                <div class="products">
                        ...
                        <a href="<?=$curlangcode?>/blog/<?=$blog->slug?>">
                            <div class="project-item">
    
                                            <div class="project-img">
                                                    <img src="/assets/uploads/blogs/thumbnails/<?=$blog->image?>" alt="<?=$blog->title?>">
                                            </div>
                              
                                            <h6 style="margin:15px 0;min-height:80px" class="prj-text text-uppercase">
                                                <?=$blog->title?>
                                            </h6>
                                            <p style="min-height:120px;color:#000;">
                                                 <?=$blog->meta_desc?>
                                            </p>
                            </div>
                        </a>
