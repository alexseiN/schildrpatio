...
$morefiles = morefiles('bsections',$feature->id);
                ...
                <?php if ($feature->template == 'videolist') {  $vl = $vl + 1;?>
                            ...
                            <a style="display:inline!important;" href="<?=$file->link?>">
                                <div class="vproduct d-flex flex-column">
                                    <div class="vproduct-bottom" style="background-image: url('assets/uploads/bsections/<?=$file->filename?>') ">
                                        <img style="width: 100%; height: 100%; display: none" src="assets/uploads/bsections/<?=$file->filename?>" >
                        ...
                        <div class="hover-main" >
                            ...
                            <div class="hover-nav-main">
                                ...
                                <div class="slider slider-nav-hover">
                                    <?php foreach ($morefiles as $file) { ?>
                                    <div><img  src="assets/uploads/bsections/<?=$file->filename?>" alt=""></div>
                                    <?php } ?>
                                </div>
                ...
                <?php if ($feature->template == 'stgallery') { ?>
                    ...
                    <div class="title">
                        ...
                        <div class="vproducts d-flex flex-row slider-for-prd aniimated-thumbnials row">
                                    ...
                                    <?php if($i<18) { ?>
                                        <a class="col-lg-4" style="padding:2px;" data-exthumbimage="assets/uploads/bsections/<?=$file->filename?>" href="assets/uploads/bsections/<?=$file->filename?>">
                                            
                                                
                                                <img style="width:100%;" src="assets/uploads/bsections/<?=$file->filename?>"/>
                                                
                                           
                                        </a>
                                    <?php } else { ?>
                                    
                                        <a class="col-lg-3" style="padding:2px;display:none;" data-exthumbimage="assets/uploads/bsections/<?=$file->filename?>" href="assets/uploads/bsections/<?=$file->filename?>">
                                            <div style="width:100%!important;" class=" d-flex flex-column product-model">
                                                
                                                <img src="assets/uploads/bsections/<?=$file->filename?>"/>
                                ...
                                <?php foreach ($morefiles as $file) { ?>
                                    ...
                                    <div class="catalog-item " id="<?php if($file->filetype == 'video') { echo 'video-gallery';}?>">
                                            <a href="<?php if($file->filetype == 'video') { echo $file->link;} else { echo $file->link;} ?>" >
                                                <div class="catalog-image  " style="background-image: url('assets/uploads/bsections/<?=$file->filename?>')">
                ...
                <?php if ($feature->template == 'fullimage') { ?>
                    ...
                    <?php foreach ($morefiles as $file) { ?>
                            ...
                            <div class="inner_main_center">
                                ...
                                <img width="100%" src="assets/uploads/bsections/<?=$file->filename?>"/>
