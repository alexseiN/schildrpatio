                        ...
                        <div class="hover-main" >
                            ...
                            <div class="hover-nav-main">
                                ...
                                <div class="slider slider-nav-hover">
                                    <?php foreach ($morefiles as $file) { ?>
                                    <div><img  src="assets/uploads/sections/<?=$file->filename?>" alt=""></div>
                                    <?php } ?>
                                </div>
                ...
                <?php if ($feature->template == 'stgallery') { ?>
                    ...
                    <div class="title">
                        ...
                        <div class="vproducts d-flex flex-row slider-for-prd aniimated-thumbnials row">
                                    ...
                                    <?php if($i<6) { ?>
                                        <a class="col-lg-4" style="padding-bottom:20px;" data-exthumbimage="assets/uploads/sections/<?=$file->filename?>" href="assets/uploads/sections/<?=$file->filename?>">
                                            
                                                
                                                <img style="width:100%;" src="assets/uploads/sections/<?=$file->filename?>"/>
                                                
                                           
                                        </a>
                                    <?php } else { ?>
                                    
                                        <a class="col-lg-3" style="padding:2px;display:none;" data-exthumbimage="assets/uploads/sections/<?=$file->filename?>" href="assets/uploads/sections/<?=$file->filename?>">
                                            <div style="width:100%!important;" class=" d-flex flex-column product-model">
                                                
                                                <img src="assets/uploads/sections/<?=$file->filename?>"/>
                                ...
                                <?php foreach ($morefiles as $file) { ?>
                                    ...
                                    <div class="catalog-item " id="<?php if($file->filetype == 'video') { echo 'video-gallery';}?>">
                                            <a href="<?php if($file->filetype == 'video') { echo $file->link;} else { echo $file->link;} ?>" >
                                                <div class="catalog-image  " style="background-image: url('assets/uploads/sections/<?=$file->filename?>')">
                ...
                <?php if ($feature->template == 'fullimage') { ?>
                    ...
                    <?php foreach ($morefiles as $file) { ?>
                            ...
                            <div class="inner_main_center">
                                ...
                                <img width="100%" src="assets/uploads/sections/<?=$file->filename?>"/>
