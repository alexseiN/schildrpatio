			...
			<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
				...
				<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
					...
					<div class="text-dark order-2 order-md-1">
						...
						<a href="https://oawo.com" target="_blank" class="text-gray-800 text-hover-primary">oawo.com</a>
					</div>
					<!--end::Copyright-->
...
<!--<script src="assets/admin/plugins/custom/vis-timeline/vis-timeline.bundle.js"></script>-->
...
-->
<?php echo view('admin/includes/topmenu/activityinner'); ?>
