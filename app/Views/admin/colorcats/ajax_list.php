...
if($objects){
    foreach($objects as $set_data){
		...
		if(!empty($language_data)){
			$image  = !empty($set_data->image)?'assets/uploads/products/thumbnails/'.$set_data->image:'assets/uploads/no-image.gif';			
?>
<tr>
	<td>
		<div class="d-flex align-items-center">
			...
			<div class="d-flex justify-content-start flex-column">
				<span class="<?=(($set_data->parent_id != 0)?'':'')?> fs-5"><?=$language_data->title?></span>
			</div>
		</div>
	</td>
    <td>
