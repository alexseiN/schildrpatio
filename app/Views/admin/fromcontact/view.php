            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8">
                            <span class="fw-bolder fs-6 text-gray-800"><?=$thisItems->{'street'}?></span>
                        </div>
                    </div>
                    <div class="row mb-7">
                    ...
                    <div class="row mb-7">
                        <label class="col-lg-4 fw-bold text-muted">Call back time</label>
                        <div class="col-lg-8">
                            <span class="fw-bolder fs-6 text-gray-800"><?=$thisItems->{'callbacktime'}?></span>
                        </div>
                    </div>
                    <div class="row mb-7">
