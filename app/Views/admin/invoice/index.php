...
<script type="text/javascript">
    ...
    function callajax(targetname,targetvalue,project_id,row_id,invoiceid,target_tr_id){
		...
		const myArray = target_tr_id.split("_");

		var lastID = myArray[2];
		
        var calltable = '#child_table_'+project_id;
        var calltr = $(calltable+' tr#'+target_tr_id);
        var checkproductvalue = $(calltable+' tr#'+target_tr_id+' #sproduct_'+row_id+'_'+lastID).val();
        ...
        if(checkproductvalue == ''){
            ...
            setTimeout(function() {
				$(calltable+' tr#'+target_tr_id+' select.colordropdown').val('');                
            }, 500);
            return false;
        }
        ...
        $(document).on("click", ".add_field_button2", function() {
            ...
            if (j < max_fields) { 
                $html = '<tr id="child_tr_' + j + '" data-product-id="create_new" data-project-id="'+mainoptionid+'" data-counter="' + j + '" ><td class="nm" style="max-width: 30px;">' + j + '</td>\
                                <td align="center">\
                                    <select data-row-id="' + j + '" data-id="create_new" name="sproduct" id="sproduct_create_new_' + j + '" aria-label="Please select" data-allow-clear="true" data-control="select2" data-placeholder="Please select" class="form-select form-select-solid form-select-lg fw-bold" >' + productOptions + '\
                                    </select>\
                                </td>\
                                ...
                                <td align="center">\
                                        <select name="scolor" data-id="create_new" data-row-id="' + j + '" aria-label="Please select" data-allow-clear="true" data-control="select2" data-placeholder="Please select" class="form-select form-select-solid form-select-lg fw-bold colordropdown" id="scolor_create_new_' + j + '" >' + colorOptions2 + '\
                                        </select>\
                                 </td>\
                                <td class="cvc" align="center" id="" data-name="fcolor">\
                                    <select aria-label="Please select" data-allow-clear="true" data-control="select2" data-placeholder="Please select" class="form-select form-select-solid form-select-lg fw-bold colordropdown" id="fcolor_create_new_' + j + '" name="fcolor" data-row-id="' + j + '" data-id="create_new"  >' + colorOptions + '\
                                    </select>\
                                </td>\
